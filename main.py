...
#time average
profiles.time_avg(minutes=10, inplace=True)
...
#detect PBL
profiles.pbl(zmin=100, zmax=3000, under_clouds=True, verbose=True)
...
#plot single profile with time average
#profiles.time_avg(minutes=60).plot(datetime=datetime, vmin=-5e3, vmax=5e4, zmax=12000, show_fog=True, show_clouds=True, show_pbl=True)

#klett inversion
profiles.klett_inversion(time_avg=20, zmin=4000, zmax=6000, remove_outliers=False, verbose=True)
