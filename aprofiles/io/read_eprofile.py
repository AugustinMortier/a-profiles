...
class ReadEPROFILE:
    ...
    def _read_l2file(self):
        ...
        dataset.attenuated_backscatter_0.attrs['long_name'] = dataset.attenuated_backscatter_0.long_name.replace('at wavelength 0','@ {} nm'.format(int(dataset.l0_wavelength.data)))
